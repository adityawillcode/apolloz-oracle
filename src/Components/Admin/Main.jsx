...
function Main() {
  return (
    <div className='w-screen h-screen flex justify-center'>
        <div className=' w-[45rem] border-x-2  border-gray-600 text-gray-400 pt-[2rem] px-4'>
        <h1 className='text-[2rem]  font-semibold border-b-[2px] border-gray-500 ' style={{fontFamily:'Nunito'}}>Recent Quizes</h1>
